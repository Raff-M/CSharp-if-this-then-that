...
namespace WpfApp2
{
    public partial class MainWindow : Window
    {
        ...
        if (tasksList[i-1].errorStr != "complete" && tasksList[i-1].errorStr != "")
                        errors++;
                else if (tasksList[i-1].errorStr == "")
                { 
            ...
            foreach (var task in tasksList)
            {
                ...
                task.work(i);
                    ...
                    if (task.errorStr != "complete" && task.errorStr != "")
                        errors++;
                    else if (task.errorStr == "")
                    {
        ...
        public void work_single()
        {
            ...
            Application.Current.Dispatcher.BeginInvoke(DispatcherPriority.Background, new Action(() =>
            {
                tasksList[tasksListBox.SelectedIndex].work(i);
